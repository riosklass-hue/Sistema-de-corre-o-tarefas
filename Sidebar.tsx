    ...
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col h-screen fixed left-0 top-0">
      <div className="p-6">
        ...
        <nav className="space-y-1">
          <button 
            onClick={onOpenChat}
            className="flex items-center gap-3 w-full px-3 py-2 text-sm font-medium text-blue-700 bg-blue-50 rounded-lg transition-colors border border-blue-100 hover:bg-blue-100"
          >
          ...
          <button 
            ...
            className="flex items-center gap-3 w-full px-3 py-2 text-sm font-medium text-indigo-700 bg-indigo-50/50 rounded-lg transition-colors border border-indigo-100 mt-2 hover:bg-indigo-100"
          >
